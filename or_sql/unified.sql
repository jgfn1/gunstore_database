...
--2. Cria√ß√£o de um tipo que contenha um atributo que seja de um outro tipo
--4. Cria√ß√£o de um tipo que contenha um atributo que seja de um tipo NESTED TABLE
...
/
--14. Altera√ß√£o de supertipo com propaga√ß√£o de mudan√ßa
...
/
--11. Altera√ß√£o de tipo: adi√ß√£o de atributo
...
--ok
--17. RestriÁ„o de escopo de referÍncia
...
INSERT INTO tb_employees VALUES (
    ...
    1000,
    10,
    'Gestor de Pistolas/RevÛlveres | Gestor de Armas Brancas | Instrutor de Tiro',
...
INSERT INTO tb_employees VALUES (
    ...
    (SELECT REF(E) FROM tb_employees E WHERE E.cpf = 010),
    tp_department(000, 'Pistolas/RevÛlveres', 000, 009));
